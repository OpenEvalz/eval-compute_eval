...
`eval-compute_eval` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/compute_eval`)
...
- `huggingface`: `nvidia/compute-eval`
