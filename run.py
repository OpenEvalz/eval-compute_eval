#!/usr/bin/env python3
"""Run ONE problem of compute_eval through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/compute_eval"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one compute_eval problem via TrustedRouter")
